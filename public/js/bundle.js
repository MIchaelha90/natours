...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoibWljaGFlbGhhOTAiLCJhIjoiY2ttN3Nxbms0MTA1djJwcXQ5YXNuaDFqdCJ9.lZNa6fzH9VcCv55qr0YJZA';
  var map = new mapboxgl.Map({
    container: 'map',
    style: 'mapbox://styles/michaelha90/ckm7uni8jdnox17rz2zbwkszo',
    scrollZoom: false // center: [-80.128473, 25.781842],
    // zoom: 10,
    // interactive: false,
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 6:
            ...
            if (res.data.status === 'success') {
              (0, _alert.showAlert)('success', "".concat(type.toUpperCase(), " updated sucessfully"));
            }
...
var stripe = Stripe('pk_test_51Ic6TdICIQXz2ksD32kSpXRzlmV9d6tZ7ijsS0lADMAO3zDxOt4SJVRUIeG0J81ZMDICDPLVZKF2zkjPvkVu04fE00kT1iqhnF');
...
var bookBtn = document.getElementById('book-tour'); // DELEGATION - only run code if DOM exist
